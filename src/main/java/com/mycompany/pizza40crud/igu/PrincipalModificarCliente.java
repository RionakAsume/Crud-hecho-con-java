 ...
 * @author imlau
 */
public class PrincipalModificarCliente extends javax.swing.JFrame {

    Clientes clientes = new Clientes();
    String _id;
   

    public PrincipalModificarCliente(String _id) {
        this._id=_id;
        initComponents();
        cargarDatos(_id);
    }
    ...
    private void initComponents() {
        ...
        txtClientesFecharegistro = new javax.swing.JTextField();
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txtClientesTelefono)
                    .addComponent(txtClientesFecharegistro)
                    .addComponent(txtClientesEmail)
                    .addComponent(txtClientesNombre, javax.swing.GroupLayout.DEFAULT_SIZE, 261, Short.MAX_VALUE))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtClientesFecharegistro, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnClienteLimpiarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnClienteLimpiarActionPerformed
        ...
        txtClientesFecharegistro.setText("");
    ...
    private void btnClienteGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnClienteGuardarActionPerformed
       String nombre = txtClientesNombre.getText();
        String direccion = txtClientesDireccion.getText();
        String telefono = txtClientesTelefono.getText();
        String email = txtClientesEmail.getText();
        String fechaRegistro = txtClientesFecharegistro.getText();

        clientes.actualizarCliente(_id, nombre, direccion, telefono, email, fechaRegistro);
        ...
        PrincipalVerCliente pantalla = new PrincipalVerCliente();
    ...
    private javax.swing.JTextField txtClientesFecharegistro;
    ...
    private void cargarDatos(String _id) {
        ...
        Document cliente = clientes.obtenerClientePorId(_id);
        if (cliente != null) {
            txtClientesNombre.setText(cliente.getString("Nombre"));
            txtClientesDireccion.setText(cliente.getString("Dirección"));
            txtClientesTelefono.setText(cliente.getString("Teléfono"));
            txtClientesEmail.setText(cliente.getString("Email"));
            txtClientesFecharegistro.setText(cliente.getString("Fecha_registro"));
        } else {
